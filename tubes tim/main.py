...
def insert( id, name, price, quantity):
    ...
    user(id_absen TEXT, itemName TEXT, itemPrice TEXT, itemQuantity TEXT)""")

    cursor.execute("INSERT INTO user VALUES ('" + str(id) + "','" + str(name) + "','" + str(price) + "','" + str(quantity) + "')")
    conn.commit()
...
def delete(data):
    ...
    cursor.execute("DELETE FROM user WHERE id_absen = '" + str(data) + "'")
    conn.commit()
...
def update(id, name, price, quantity,  idName):
    ...
    cursor.execute("UPDATE user SET id_absen = '" + str(id) + "', itemName = '" + str(name) + "', itemPrice = '" + str(price) + "', itemQuantity = '" + str(quantity) + "' WHERE id_absen='"+str(idName)+"'")
    conn.commit()
...
def read():
    ...
    cursor.execute("""CREATE TABLE IF NOT EXISTS 
        user(id_absen TEXT, me TEXT, itemPrice TEXT, itemQuantity TEXT)""")
